/*
    Questo file contiene l'implementazione partially parallel con omp
    dell'algoritmo lineare. Per "partially parallel" si intende che tutte 
    le fasi di computazione delle particelle sono eseguite in parallelo tranne 
